    ...
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              <Link to="/products" style={{ backgroundColor: '#fff', color: '#000', padding: '18px 48px', borderRadius: '12px', fontWeight: '800', fontSize: '16px', textDecoration: 'none', transition: '0.2s', boxShadow: '0 10px 30px rgba(255,255,255,0.1)' }}>Shop Now</Link>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div style={{ backgroundColor: '#1a1a1a', borderRadius: '32px', padding: '32px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', minHeight: '300px', backgroundImage: 'url("/images/tshirt_product_1774987745271.png")', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: '16px' }}>
               <div style={{ backgroundColor: '#E50010', borderRadius: '32px', padding: '32px', position: 'relative' }}>
               ...
               <div style={{ backgroundColor: '#111', borderRadius: '32px', padding: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <img src="/images/tracksuit_product_1774987761220.png" alt="ad" style={{ maxHeight: '100px', width: 'auto' }} />
               </div>
            </div>
          </div>
      ...
      <section style={{ maxWidth: '1400px', margin: '0 auto', padding: '100px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '32px' }}>
          {categories.map(cat => (
            <Link key={cat.name} to={`/products?gender=${cat.gender || cat.name}`} style={{ textDecoration: 'none', borderRadius: '32px', overflow: 'hidden', height: '400px', position: 'relative', display: 'block', boxShadow: '0 20px 40px rgba(0,0,0,0.08)' }}>
              <img src={cat.img} alt={cat.name} style={{ width: '100%', height: '100%', objectFit: 'cover', transition: '0.5s transform' }} onMouseEnter={e => e.target.style.transform = 'scale(1.1)'} onMouseLeave={e => e.target.style.transform = 'scale(1)'} />
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(0,0,0,0.9), transparent)', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '40px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '24px' }}>
                   ...
                   <div style={{ backgroundColor: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)', padding: '8px 16px', borderRadius: '100px', fontSize: '11px', color: '#fff', fontWeight: '800' }}>10+ Collections</div>
                </div>
              </div>
            </Link>
          ))}
